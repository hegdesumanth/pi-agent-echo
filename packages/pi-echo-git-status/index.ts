 ...
 * unlike pi-echo-hooks/pi-echo-statusline) with a single combined
 ...
 * `pi-echo-checkpoints` already established for exactly this situation.
 * Refreshed on `session_start` and after every `turn_end`, matching
 * `pi-echo-statusline`'s cadence.
 */
